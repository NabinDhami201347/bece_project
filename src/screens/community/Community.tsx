...
const posts = [
  ...
  },
  {
    ...
    author: "Nabin Dhami",
    date: "August 1, 2025",
    image: "https://th.bing.com/th/id/R.2b7d505bd3e7b290420bf537056685ec?rik=V7bN%2bB5lzbOUOA&pid=ImgRaw&r=0",
  },
];

const CommunityScreen = () => {
  const renderPost = ({ item }) => (
    <Post title={item.title} description={item.description} author={item.author} date={item.date} image={item.image} />
  );
